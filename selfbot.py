...
if connecting['token'] == "":
     client = LINE("shawnmedes8@gmail.com","123456sa")
else:
    client=LINE(authToken=connecting['token'])
connecting["token"] = client.authToken
with open('token.json', 'w') as fp:
    json.dump(connecting, fp, sort_keys=True, indent=4)
with open('owner.json', 'r') as fp:
    check = json.load(fp)
with open('connect.json', 'r') as fp:
    Connect_to = json.load(fp)
print("\n#==================================================#")
print("YOUR TOKEN: " + client.authToken )
print("\n#=============[SELFBOT RUNNING]====================#")
        ...
        if op.type in [25,26]:
            ...
            if msg.contentType == 7:
                if Connect_to['IDSticker'] == True:
                    ...
                    client.goperation(send,man,"My Code Sticker\n","" + "\n\n" + str(filler))
                else:
                    pass
        ...
        if op.type == 25:
            ...
            if msg.contentType == 1:
              if Connect_to['Upfoto'] == True:
                if man in check["owner"]:
                    path = client.downloadObjectMsg(msg.id)
                    client.updateProfilePicture(path)
                    client.goperation(send,man," Update Picture Success ","")
            ...
            if msg.contentType == 1:
              if Connect_to['UpfotoGroup'] == True:
                if man in Team or man in Connect_to["Admin"]:
                    ...
                    client.goperation(send,man," Update Picture Grup Success ","")
                    ...
                    if Connect_to['AutoRespon'] == True:
                        ...
                        for mention in mentionees:
                              if mention['M'] in myMID:
                                  client.goperation(send,man,"","" +str(ret_))
                                  break
                    ...
                    if Connect_to["autoRead"] == True:
                        ...
                        if msgText.lower() == '_PYTHON3_':
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                ...
                                client.goperation(send,man," Hay","")
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                ...
                                client.goperation(send,myMID," Ready On ","" + str(" ("+team1+")"))
                          ...
                          if man in Team or man in Connect_to["Admin"]:
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                try:
                                    ...
                                    client.goperation(send,man,"Invite Done","")
                                    contact = client.getContact(GC.mid)
                                except:
                                    W = group.members[0].mid
                                    client.sendMessage(send, None, contentMetadata={'mid': W}, contentType=13)
                          ...
                          if man in Team or man in Connect_to["Admin"]:
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                ...
                                gid = client.getGroupIdsJoined()
                                for i in gid:
                                    client.goperation(i,man," BROADCAST BY:","\n" + str(" ("+bc+")"))
                            ...
                            if man in Team:
                                ...
                                client.goperation(send,Admin," Update Name Success","\n Change to " + str(change))
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                try:
                                    ...
                                    client.goperation(send,man," Remove Message Success ","\n In Grup" + str(" ("+ginfo.name+")"))
                                except:
                                    pass
                            ...
                            if man in Team:
                                client.goperation(send,man," Akses Off","")
                                print ("Selfbot Off")
                                exit(1)
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                try:
                                    ...
                                    Connect_to['KickOn'] = False
                                    Connect_to['SpamInvite'] = False
                                    with open('connect.json', 'w') as fp:
                                        json.dump(Connect_to, fp, sort_keys=True, indent=4)
                          ...
                          if man in Team or man in Connect_to["Admin"]:
                            ...
                            if man in Team or man in Connect_to["Admin"]:
                                 ...
                                 if True:
                                    ...
                                    client.sendImageWithURL(send, cover)
                                    client.goperation(send,conn.mid,"Tag User\n","")
